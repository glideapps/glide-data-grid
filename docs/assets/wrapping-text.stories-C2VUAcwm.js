import{R as e}from"./iframe-DEB48SRF.js";import{D as f}from"./data-editor-all-BmHrOGhF.js";import{B as d,D as C,P as h,u as x,d as w}from"./utils-BS2L_WIh.js";import{G as y}from"./image-window-loader-EVQTWTwV.js";import{S as W}from"./story-utils-BPcW-dYq.js";import{r as D}from"./throttle-B0y0PPFT.js";import{y as E}from"./index-D_kXk1yT.js";import"./flatten-C8dAZ1b9.js";import"./scrolling-data-grid-CPCBm3k8.js";import"./marked.esm-BmIu7KBL.js";import"./index.esm-Cp3_DO_w.js";import"./index-HZH32G8C.js";const S={title:"Glide-Data-Grid/DataEditor Demos",decorators:[t=>e.createElement(W,null,e.createElement(d,{title:"Wrapping Text",description:e.createElement(C,null,"Text cells can have wrapping text by setting the ",e.createElement(h,null,"allowWrapping")," prop to true.")},e.createElement(t,null)))]},n=t=>{const{cols:m,getCellContent:l,onColumnResize:c}=x(6),r=e.useMemo(()=>D(0,100).map(()=>E.lorem.sentence(t.length)),[t.length]),g=e.useCallback(o=>{const[u,a]=o;return u===0?{kind:y.Text,allowOverlay:!0,displayData:`${a},
${r[a%r.length]}`,data:`${a}, 
