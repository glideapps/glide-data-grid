import{R as e}from"./iframe-CPneofTP.js";import{D as f}from"./data-editor-all-DPQRAXKP.js";import{B as d,D as C,P as h,u as x,d as w}from"./utils-sCjGiEfH.js";import{G as y}from"./image-window-loader-B8Yl68IE.js";import{S as W}from"./story-utils-rieT2nEI.js";import{r as D}from"./throttle-BIB5pUD_.js";import{y as E}from"./index-D_kXk1yT.js";import"./flatten-rCnKTmuy.js";import"./scrolling-data-grid-JMx0a2mS.js";import"./marked.esm-CKjSmi8N.js";import"./index.esm-jTBCXl10.js";import"./index-RxCN9haR.js";const S={title:"Glide-Data-Grid/DataEditor Demos",decorators:[t=>e.createElement(W,null,e.createElement(d,{title:"Wrapping Text",description:e.createElement(C,null,"Text cells can have wrapping text by setting the ",e.createElement(h,null,"allowWrapping")," prop to true.")},e.createElement(t,null)))]},n=t=>{const{cols:m,getCellContent:l,onColumnResize:c}=x(6),r=e.useMemo(()=>D(0,100).map(()=>E.lorem.sentence(t.length)),[t.length]),g=e.useCallback(o=>{const[u,a]=o;return u===0?{kind:y.Text,allowOverlay:!0,displayData:`${a},
${r[a%r.length]}`,data:`${a}, 
