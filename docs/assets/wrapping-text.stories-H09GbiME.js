import{R as e}from"./iframe-BoOn4LYH.js";import{D as f}from"./data-editor-all-CD5asUdq.js";import{B as d,D as C,P as h,u as x,d as w}from"./utils-DCZm_Szc.js";import{G as y}from"./image-window-loader-BPw4el3K.js";import{S as W}from"./story-utils-DREv_L_H.js";import{r as D}from"./throttle-iyk7jJUC.js";import{y as E}from"./index-D_kXk1yT.js";import"./flatten-CkDMYA6f.js";import"./scrolling-data-grid-CgfvknEg.js";import"./marked.esm-3FIuRmsv.js";import"./index.esm-yBRnM_XV.js";import"./index-HHzigBTA.js";const S={title:"Glide-Data-Grid/DataEditor Demos",decorators:[t=>e.createElement(W,null,e.createElement(d,{title:"Wrapping Text",description:e.createElement(C,null,"Text cells can have wrapping text by setting the ",e.createElement(h,null,"allowWrapping")," prop to true.")},e.createElement(t,null)))]},n=t=>{const{cols:m,getCellContent:l,onColumnResize:c}=x(6),r=e.useMemo(()=>D(0,100).map(()=>E.lorem.sentence(t.length)),[t.length]),g=e.useCallback(o=>{const[u,a]=o;return u===0?{kind:y.Text,allowOverlay:!0,displayData:`${a},
${r[a%r.length]}`,data:`${a}, 
