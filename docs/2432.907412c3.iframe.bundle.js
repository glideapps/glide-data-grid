"use strict";
(self["webpackChunkroot"] = self["webpackChunkroot"] || []).push([[2432],{
...
// EXTERNAL MODULE: ./packages/core/src/internal/data-grid/draw-checkbox.ts
var draw_checkbox = __webpack_require__("./packages/core/src/internal/data-grid/draw-checkbox.ts");
...
const uriCellRenderer = {
  ...
  onClick: a => {
    ...
    const didClick = (0,data_grid_render/* pointInRect */.qr)({
      x: textRect.x - 4,
      y: textRect.y - 4,
...
/* harmony export */ });
/* harmony import */ var _internal_data_grid_data_grid_lib_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./packages/core/src/internal/data-grid/data-grid-lib.ts");
...
function getClosestRect(rect, px, py, allowedDirections) {
  ...
  if ((0,_internal_data_grid_data_grid_lib_js__WEBPACK_IMPORTED_MODULE_0__/* .itemIsInRect */ .X4)([px, py], rect)) {
    return undefined;
  }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Bi": () => (/* binding */ drawCell),
/* harmony export */   "Dq": () => (/* binding */ getActionBoundsForGroup),
/* harmony export */   "Kw": () => (/* binding */ drawGrid),
/* harmony export */   "lE": () => (/* binding */ drawHeader),
/* harmony export */   "qr": () => (/* binding */ pointInRect),
/* harmony export */   "uP": () => (/* binding */ getHeaderMenuBounds)
/* harmony export */ });
/* harmony import */ var _data_grid_types_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./packages/core/src/internal/data-grid/data-grid-types.ts");
/* harmony import */ var lodash_groupBy_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./node_modules/lodash/groupBy.js");
/* harmony import */ var lodash_groupBy_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_groupBy_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _data_grid_lib_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./packages/core/src/internal/data-grid/data-grid-lib.ts");
/* harmony import */ var _common_styles_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./packages/core/src/common/styles.ts");
/* harmony import */ var _color_parser_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./packages/core/src/internal/data-grid/color-parser.ts");
/* harmony import */ var _common_support_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("./packages/core/src/common/support.ts");
/* harmony import */ var _common_utils_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./packages/core/src/common/utils.tsx");
/* harmony import */ var _draw_checkbox_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./packages/core/src/internal/data-grid/draw-checkbox.ts");
/* harmony import */ var _common_math_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("./packages/core/src/common/math.ts");
...
const loadingCell = {
  kind: _data_grid_types_js__WEBPACK_IMPORTED_MODULE_1__/* .GridCellKind.Loading */ .p6.Loading,
  allowOverlay: false
};
...
function drawCell(ctx, cell, col, row, isLastCol, isLastRow, x, y, w, h, highlighted, theme, finalCellFillColor, imageLoader, spriteManager, hoverAmount, hoverInfo, hyperWrapping, frameTime, drawCellCallback, lastPrep, enqueue, renderStateProvider, getCellRenderer, overrideCursor) {
  ...
  const needsAnim = (0,_data_grid_lib_js__WEBPACK_IMPORTED_MODULE_2__/* .drawLastUpdateUnderlay */ .vr)(args, cell.lastUpdated, frameTime, lastPrep, isLastCol, isLastRow);
  ...
  if (r !== undefined) {
    ...
    if (drawCellCallback !== undefined && !(0,_data_grid_types_js__WEBPACK_IMPORTED_MODULE_1__/* .isInnerOnlyCell */ .rs)(args.cell)) {
...
function blitLastFrame(ctx, blitSource, blitSourceScroll, targetScroll, last, cellXOffset, cellYOffset, translateX, translateY, freezeTrailingRows, width, height, rows, totalHeaderHeight, dpr, mappedColumns, effectiveCols, getRowHeight, doubleBuffer) {
  ...
  let stickyWidth = (0,_data_grid_lib_js__WEBPACK_IMPORTED_MODULE_2__/* .getStickyWidth */ .G6)(effectiveCols);
  ...
  const freezeTrailingRowsHeight = freezeTrailingRows > 0 ? (0,_data_grid_lib_js__WEBPACK_IMPORTED_MODULE_2__/* .getFreezeTrailingHeight */ .YN)(rows, freezeTrailingRows, getRowHeight) : 0;
...
function drawGridLines(ctx, effectiveCols, cellYOffset, translateX, translateY, width, height, drawRegions, spans, groupHeaderHeight, totalHeaderHeight, getRowHeight, getRowThemeOverride, verticalBorder, freezeTrailingRows, rows, theme) {
  ...
  const groups = lodash_groupBy_js__WEBPACK_IMPORTED_MODULE_0___default()(toDraw, line => line.color);
...
function drawGroups(ctx, effectiveCols, width, translateX, groupHeaderHeight, hovered, theme, spriteManager, _hoverValues, verticalBorder, getGroupDetails, damage) {
  ...
  walkGroups(effectiveCols, width, translateX, groupHeaderHeight, (span, groupName, x, y, w, h) => {
    ...
    const groupTheme = (group === null || group === void 0 ? void 0 : group.overrideTheme) === undefined ? theme : (0,_common_styles_js__WEBPACK_IMPORTED_MODULE_3__/* .mergeAndRealizeTheme */ .yR)(theme, group.overrideTheme);
    ...
    if (group !== undefined) {
      ...
      ctx.fillText(group.name, drawX + xPad, groupHeaderHeight / 2 + (0,_data_grid_lib_js__WEBPACK_IMPORTED_MODULE_2__/* .getMiddleCenterBias */ .aX)(ctx, theme.headerFontFull));
      if (group.actions !== undefined && isHovered) {
        ...
        const trans = (0,_color_parser_js__WEBPACK_IMPORTED_MODULE_4__/* .withAlpha */ .fG)(fillColor, 0);
...
function drawHeaderInner(ctx, x, y, width, height, c, selected, theme, isHovered, hoverAmount, spriteManager, touchMode, isRtl, isCheckboxHeader, menuBounds) {
  if (isCheckboxHeader) {
    ...
    if (c.title === _data_grid_types_js__WEBPACK_IMPORTED_MODULE_1__/* .headerCellCheckedMarker */ .qT) checked = true;
    if (c.title === _data_grid_types_js__WEBPACK_IMPORTED_MODULE_1__/* .headerCellUnheckedMarker */ .YK) checked = false;
    if (checked !== true) {
      ctx.globalAlpha = hoverAmount;
    }
    (0,_draw_checkbox_js__WEBPACK_IMPORTED_MODULE_5__/* .drawCheckbox */ ._)(ctx, theme, checked, x, y, width, height, false, undefined, undefined, 18);
    if (checked !== true) {
      ctx.globalAlpha = 1;
    }
    return;
  ...
  if (shouldDrawMenu && c.hasMenu === true && width > 35) {
    ...
    const trans = (0,_color_parser_js__WEBPACK_IMPORTED_MODULE_4__/* .withAlpha */ .fG)(fillStyle, 0);
  ...
  ctx.fillText(c.title, drawX, y + height / 2 + (0,_data_grid_lib_js__WEBPACK_IMPORTED_MODULE_2__/* .getMiddleCenterBias */ .aX)(ctx, theme.headerFontFull));
  if (isRtl) {
    ctx.textAlign = "left";
  }
  if (shouldDrawMenu && c.hasMenu === true) {
    if (c.menuIcon === undefined || c.menuIcon === _data_grid_types_js__WEBPACK_IMPORTED_MODULE_1__/* .GridColumnMenuIcon.Triangle */ .pN.Triangle) {
      ctx.beginPath();
      const triangleX = menuBounds.x + menuBounds.width / 2 - 5.5;
      const triangleY = menuBounds.y + menuBounds.height / 2 - 3;
      (0,_data_grid_lib_js__WEBPACK_IMPORTED_MODULE_2__/* .roundedPoly */ .zu)(ctx, [{
        x: triangleX,
        y: triangleY
      }, {
        x: triangleX + 11,
      ...
      ctx.fillStyle = fillStyle;
      ctx.fill();
    } else if (c.menuIcon === _data_grid_types_js__WEBPACK_IMPORTED_MODULE_1__/* .GridColumnMenuIcon.Dots */ .pN.Dots) {
      ctx.beginPath();
      const dotsX = menuBounds.x + menuBounds.width / 2;
      const dotsY = menuBounds.y + menuBounds.height / 2;
      (0,_data_grid_lib_js__WEBPACK_IMPORTED_MODULE_2__/* .drawMenuDots */ .Ld)(ctx, dotsX, dotsY);
      ctx.fillStyle = fillStyle;
      ctx.fill();
    } else {
...
function drawHeader(ctx, x, y, width, height, c, selected, theme, isHovered, hasSelectedCell, hoverAmount, spriteManager, drawHeaderCallback, touchMode) {
  const isCheckboxHeader = c.title.startsWith(_data_grid_types_js__WEBPACK_IMPORTED_MODULE_1__/* .headerCellCheckboxPrefix */ .Gf);
  const isRtl = (0,_common_utils_js__WEBPACK_IMPORTED_MODULE_6__/* .direction */ .o7)(c.title) === "rtl";
...
function drawGridHeaders(ctx, effectiveCols, enableGroups, hovered, width, translateX, headerHeight, groupHeaderHeight, dragAndDropState, isResizing, selection, outerTheme, spriteManager, hoverValues, verticalBorder, getGroupDetails, damage, drawHeaderCallback, touchMode) {
  ...
  walkColumns(effectiveCols, 0, translateX, 0, totalHeaderHeight, (c, x, _y, clipX) => {
    ...
    const theme = c.themeOverride === undefined && groupTheme === undefined ? outerTheme : (0,_common_styles_js__WEBPACK_IMPORTED_MODULE_3__/* .mergeAndRealizeTheme */ .yR)(outerTheme, groupTheme, c.themeOverride);
...
function drawCells(ctx, effectiveColumns, allColumns, height, totalHeaderHeight, translateX, translateY, cellYOffset, rows, getRowHeight, getCellContent, getGroupDetails, getRowThemeOverride, disabledRows, isFocused, drawFocus, freezeTrailingRows, hasAppendRow, drawRegions, damage, selection, prelightCells, highlightRegions, imageLoader, spriteManager, hoverValues, hoverInfo, drawCellCallback, hyperWrapping, outerTheme, enqueue, renderStateProvider, getCellRenderer, overrideCursor, minimumCellWidth) {
  ...
  walkColumns(effectiveColumns, cellYOffset, translateX, translateY, totalHeaderHeight, (c, drawX, colDrawStartY, clipX, startRow) => {
    ...
    const colTheme = c.themeOverride === undefined && groupTheme === undefined ? outerTheme : (0,_common_styles_js__WEBPACK_IMPORTED_MODULE_3__/* .mergeAndRealizeTheme */ .yR)(outerTheme, groupTheme, c.themeOverride);
    ...
    walkRowsInCol(startRow, colDrawStartY, height, rows, getRowHeight, freezeTrailingRows, hasAppendRow, (drawY, row, rh, isSticky, isTrailingRow) => {
      ...
      const theme = cell.themeOverride === undefined && rowTheme === undefined && trailingTheme === undefined ? colTheme : (0,_common_styles_js__WEBPACK_IMPORTED_MODULE_3__/* .mergeAndRealizeTheme */ .yR)(colTheme, rowTheme, trailingTheme, cell.themeOverride);
      ctx.beginPath();
      const isSelected = (0,_data_grid_lib_js__WEBPACK_IMPORTED_MODULE_2__/* .cellIsSelected */ .Sb)(cellIndex, cell, selection);
      let accentCount = (0,_data_grid_lib_js__WEBPACK_IMPORTED_MODULE_2__/* .cellIsInRange */ .H1)(cellIndex, cell, selection);
      ...
      const bgCell = cell.kind === _data_grid_types_js__WEBPACK_IMPORTED_MODULE_1__/* .GridCellKind.Protected */ .p6.Protected ? theme.bgCellMedium : theme.bgCell;
      let fill;
      if (isSticky || bgCell !== outerTheme.bgCell) {
        fill = (0,_color_parser_js__WEBPACK_IMPORTED_MODULE_4__/* .blend */ .NH)(bgCell, fill);
      }
      if (accentCount > 0 || rowDisabled) {
        if (rowDisabled) {
          fill = (0,_color_parser_js__WEBPACK_IMPORTED_MODULE_4__/* .blend */ .NH)(theme.bgHeader, fill);
        }
        for (let i = 0; i < accentCount; i++) {
          fill = (0,_color_parser_js__WEBPACK_IMPORTED_MODULE_4__/* .blend */ .NH)(theme.accentLight, fill);
        }
      } else if (prelightCells !== undefined) {
        for (const pre of prelightCells) {
          if (pre[0] === c.sourceIndex && pre[1] === row) {
            fill = (0,_color_parser_js__WEBPACK_IMPORTED_MODULE_4__/* .blend */ .NH)(theme.bgSearchResult, fill);
            break;
          }
        }
      }
      if (highlightRegions !== undefined) {
        for (let i = 0; i < highlightRegions.length; i++) {
          ...
          if (region.style !== "solid-outline" && r.x <= c.sourceIndex && c.sourceIndex < r.x + r.width && r.y <= row && row < r.y + r.height) {
            fill = (0,_color_parser_js__WEBPACK_IMPORTED_MODULE_4__/* .blend */ .NH)(region.color, fill);
          }
        }
      }
      ...
      if (damage !== undefined) {
        ...
        fill = fill === undefined ? theme.bgCell : (0,_color_parser_js__WEBPACK_IMPORTED_MODULE_4__/* .blend */ .NH)(fill, theme.bgCell);
      }
...
function drawBlanks(ctx, effectiveColumns, allColumns, width, height, totalHeaderHeight, translateX, translateY, cellYOffset, rows, getRowHeight, getRowTheme, selectedRows, disabledRows, freezeTrailingRows, hasAppendRow, drawRegions, damage, theme) {
  ...
  walkColumns(effectiveColumns, cellYOffset, translateX, translateY, totalHeaderHeight, (c, drawX, colDrawY, clipX, startRow) => {
    ...
    walkRowsInCol(startRow, colDrawY, height, rows, getRowHeight, freezeTrailingRows, hasAppendRow, (drawY, row, rh, isSticky) => {
      ...
      const blankTheme = rowTheme === undefined ? theme : (0,_common_styles_js__WEBPACK_IMPORTED_MODULE_3__/* .mergeAndRealizeTheme */ .yR)(theme, rowTheme);
...
function drawHighlightRings(ctx, width, height, cellXOffset, cellYOffset, translateX, translateY, mappedColumns, freezeColumns, headerHeight, groupHeaderHeight, rowHeight, freezeTrailingRows, rows, allHighlightRegions, theme) {
  ...
  const freezeLeft = (0,_data_grid_lib_js__WEBPACK_IMPORTED_MODULE_2__/* .getStickyWidth */ .G6)(mappedColumns);
  const freezeBottom = (0,_data_grid_lib_js__WEBPACK_IMPORTED_MODULE_2__/* .getFreezeTrailingHeight */ .YN)(rows, freezeTrailingRows, rowHeight);
  ...
  const drawRects = highlightRegions.map(h => {
    ...
    return (0,_common_math_js__WEBPACK_IMPORTED_MODULE_7__/* .splitRectIntoRegions */ .jd)(r, splitIndicies, width, height, splitLocations).map(arg => {
      const rect = arg.rect;
      const topLeftBounds = (0,_data_grid_lib_js__WEBPACK_IMPORTED_MODULE_2__/* .computeBounds */ .Ve)(rect.x, rect.y, width, height, groupHeaderHeight, headerHeight + groupHeaderHeight, cellXOffset, cellYOffset, translateX, translateY, rows, freezeColumns, freezeTrailingRows, mappedColumns, rowHeight);
      const bottomRightBounds = rect.width === 1 && rect.height === 1 ? topLeftBounds : (0,_data_grid_lib_js__WEBPACK_IMPORTED_MODULE_2__/* .computeBounds */ .Ve)(rect.x + rect.width - 1, rect.y + rect.height - 1, width, height, groupHeaderHeight, headerHeight + groupHeaderHeight, cellXOffset, cellYOffset, translateX, translateY, rows, freezeColumns, freezeTrailingRows, mappedColumns, rowHeight);
      ...
      return {
        ...
        style,
        clip: arg.clip,
        rect: (0,_common_math_js__WEBPACK_IMPORTED_MODULE_7__/* .hugRectToTarget */ .$y)({
          x: topLeftBounds.x,
          y: topLeftBounds.y,
    ...
    for (const dr of drawRects) {
      for (const s of dr) {
        if ((s === null || s === void 0 ? void 0 : s.rect) !== undefined && intersectRect(0, 0, width, height, s.rect.x, s.rect.y, s.rect.width, s.rect.height)) {
          ...
          const needsClip = !(0,_common_math_js__WEBPACK_IMPORTED_MODULE_7__/* .rectContains */ .tJ)(s.clip, s.rect);
          if (needsClip) {
            ctx.save();
          ...
          ctx.strokeStyle = s.style === "solid-outline" ? (0,_color_parser_js__WEBPACK_IMPORTED_MODULE_4__/* .blend */ .NH)((0,_color_parser_js__WEBPACK_IMPORTED_MODULE_4__/* .blend */ .NH)(s.color, theme.borderColor), theme.bgCell) : (0,_color_parser_js__WEBPACK_IMPORTED_MODULE_4__/* .withAlpha */ .fG)(s.color, 1);
...
function drawFocusRing(ctx, width, height, cellYOffset, translateX, translateY, effectiveCols, allColumns, theme, totalHeaderHeight, selectedCell, getRowHeight, getCellContent, freezeTrailingRows, hasAppendRow, fillHandle, rows) {
  ...
  const stickRowHeight = freezeTrailingRows > 0 && !isStickyRow ? (0,_data_grid_lib_js__WEBPACK_IMPORTED_MODULE_2__/* .getFreezeTrailingHeight */ .YN)(rows, freezeTrailingRows, getRowHeight) - 1 : 0;
...
function computeCanBlit(current, last) {
  ...
  if (current.mappedColumns !== last.mappedColumns) {
    ...
    for (let i = 0; i < current.mappedColumns.length; i++) {
      ...
      if ((0,_common_support_js__WEBPACK_IMPORTED_MODULE_8__/* .deepEqual */ .vZ)(curCol, lastCol)) continue;
      ...
      if (!(0,_common_support_js__WEBPACK_IMPORTED_MODULE_8__/* .deepEqual */ .vZ)(curRest, lastRest)) return false;
      resized = i;
    }
...
function drawGrid(arg, lastArg) {
  ...
  const effectiveCols = (0,_data_grid_lib_js__WEBPACK_IMPORTED_MODULE_2__/* .getEffectiveColumns */ .ih)(mappedColumns, cellXOffset, width, dragAndDropState, translateX);
  let drawRegions = [];
  ...
  const drawHeaderTexture = () => {
    ...
    overlayCtx.strokeStyle = (0,_color_parser_js__WEBPACK_IMPORTED_MODULE_4__/* .blend */ .NH)((_ref2 = (_theme$headerBottomBo = theme.headerBottomBorderColor) !== null && _theme$headerBottomBo !== void 0 ? _theme$headerBottomBo : theme.horizontalBorderColor) !== null && _ref2 !== void 0 ? _ref2 : theme.borderColor, theme.bgHeader);
    overlayCtx.stroke();
  ...
  if (damage !== undefined) {
    ...
    const doDamage = ctx => {
      ...
      if (fillHandle && drawFocus && selectionCurrent !== undefined && damage.has((0,_data_grid_lib_js__WEBPACK_IMPORTED_MODULE_2__/* .rectBottomRight */ .zU)(selectionCurrent.range))) {
  ...
  if (canBlit === true) {
    (0,_common_support_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .hu)(blitSource !== undefined && last !== undefined);
    const {
      regions
    ...
    (0,_common_support_js__WEBPACK_IMPORTED_MODULE_8__/* .assert */ .hu)(last !== undefined);
  ...
  if (isResizing) {
    walkColumns(effectiveCols, 0, translateX, 0, totalHeaderHeight, (c, x) => {
      if (c.sourceIndex === resizeCol) {
        ...
        drawColumnResizeOutline(overlayCtx, x + c.width, 0, totalHeaderHeight + 1, (0,_color_parser_js__WEBPACK_IMPORTED_MODULE_4__/* .blend */ .NH)((_theme$resizeIndicato = theme.resizeIndicatorColor) !== null && _theme$resizeIndicato !== void 0 ? _theme$resizeIndicato : theme.accentLight, theme.bgHeader));
        drawColumnResizeOutline(targetCtx, x + c.width, totalHeaderHeight, height, (0,_color_parser_js__WEBPACK_IMPORTED_MODULE_4__/* .blend */ .NH)((_theme$resizeIndicato2 = theme.resizeIndicatorColor) !== null && _theme$resizeIndicato2 !== void 0 ? _theme$resizeIndicato2 : theme.accentLight, theme.bgCell));
        return true;
      }
      return false;
    });
...
function walkGroups(effectiveCols, width, translateX, groupHeaderHeight, cb) {
  ...
  for (let index = 0; index < effectiveCols.length; index++) {
    ...
    while (end < effectiveCols.length && (0,_data_grid_lib_js__WEBPACK_IMPORTED_MODULE_2__/* .isGroupEqual */ .PU)(effectiveCols[end].group, startCol.group) && effectiveCols[end].sticky === effectiveCols[index].sticky) {
...
const DataGrid = (p, forwardedRef) => {
  ...
  const draw = react.useCallback(() => {
    ...
    if (current.damage === undefined) {
      ...
      (0,data_grid_render/* drawGrid */.Kw)(current, last);
    } else {
      (0,data_grid_render/* drawGrid */.Kw)(current, undefined);
    }
  ...
  const groupHeaderActionForEvent = react.useCallback((group, bounds, localEventX, localEventY) => {
    ...
    if (groupDesc.actions !== undefined) {
      const boxes = (0,data_grid_render/* getActionBoundsForGroup */.Dq)(bounds, groupDesc.actions);
      for (const [i, box] of boxes.entries()) {
        if ((0,data_grid_render/* pointInRect */.qr)(box, localEventX + bounds.x, localEventY + box.y)) {
  ...
  const isOverHeaderMenu = react.useCallback((canvas, col, clientX, clientY) => {
    ...
    if (!isDragging && !isResizing && header.hasMenu === true && !(hoveredOnEdge !== null && hoveredOnEdge !== void 0 ? hoveredOnEdge : false)) {
      ...
      const menuBounds = (0,data_grid_render/* getHeaderMenuBounds */.uP)(headerBounds.x, headerBounds.y, headerBounds.width, headerBounds.height, (0,utils/* direction */.o7)(header.title) === "rtl");
        ...
        if (row !== undefined) {
          ...
          if (ctx !== null) {
            ...
            if (row === -1) {
              ...
              (0,data_grid_render/* drawHeader */.lE)(ctx, 0, 0, boundsForDragTarget.width, boundsForDragTarget.height, mappedColumns[col], false, theme, false, false, 0, spriteManager, drawHeaderCallback, false);
            } else {
              ctx.font = theme.baseFontFull;
              ctx.fillStyle = theme.bgCell;
              ctx.fillRect(0, 0, offscreen.width, offscreen.height);
              (0,data_grid_render/* drawCell */.Bi)(ctx, getCellContent([col, row]), 0, row, false, false, 0, 0, boundsForDragTarget.width, boundsForDragTarget.height, false, theme, theme.bgCell, imageLoader, spriteManager, 1, undefined, false, 0, undefined, undefined, undefined, renderStateProvider, getCellRenderer, () => undefined);
            }
          }
...
/***/ "./packages/core/src/internal/data-grid/draw-checkbox.ts":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _data_grid_lib_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./packages/core/src/internal/data-grid/data-grid-lib.ts");
...
//# sourceMappingURL=2432.907412c3.iframe.bundle.js.map