...
export declare function measureColumn(ctx: CanvasRenderingContext2D, theme: FullTheme, c: GridColumn, colIndex: number, selectedData: CellArray, minColumnWidth: number, maxColumnWidth: number, getCellRenderer: GetCellRendererCallback): SizedGridColumn;
/** @category Hooks */
