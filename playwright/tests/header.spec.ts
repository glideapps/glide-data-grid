...
import { CELL_HORIZONTAL_PADDING, COLUMN_CORNER_SAFE_OFFSET, HEADER_HEIGHT } from "../constants/grid";
...
test.describe("Header", () => {
    ...
    test("highlight column group", async ({ page }) => {
        ...
        await gridPage.clickOnColumnGroup(2, { position: { x: COLUMN_CORNER_SAFE_OFFSET, y: HEADER_HEIGHT / 2 } });
