...
function buildCellsForSelectionGetter(
  dataBuilder: DataBuilder
): DataGridSearchProps['getCellsForSelection'] {
...
const getShortCellsForSelection = jest.fn(
...
describe('use-column-sizer', () => {
  ...
  it("Measures new columns when they arrive, doesn't re-measure existing ones", async () => {
    ...
    rerender({
      ...
      columns:
        A_COPY_OF_COLUMNS_THAT_ALSO_HAS_A_NEW_COLUMN_TITLED_C_THAT_WE_WILL_MEASURE_SOON_ENOUGH, // I told you!
    });
