...
/** @category Types */
export interface GroupHeaderClickedEventArgs
  extends GridMouseGroupHeaderEventArgs,
    PreventableEvent {}
...
/** @category Types */
export interface GridMouseHeaderEventArgs
  extends BaseGridMouseEventArgs,
...
/** @category Types */
export interface GridMouseGroupHeaderEventArgs
  extends BaseGridMouseEventArgs,
    PositionableMouseEventArgs {
