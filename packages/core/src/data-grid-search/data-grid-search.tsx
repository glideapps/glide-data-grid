...
import { CellArray, GetCellsThunk, GridCell, GridCellKind, Item, Rectangle } from "../data-grid/data-grid-types";
...
const DataGridSearch: React.ForwardRefRenderFunction<DataGridSearchRef, DataGridSearchProps> = (p, forwardedRef) => {
    ...
    const subscriptionCallbacksRef = React.useRef<Set<(searchStatus?: SearchStatus) => void>>(new Set());
