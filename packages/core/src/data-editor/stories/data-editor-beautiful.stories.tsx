...
export const RearrangePrimaryColumn: React.VFC = () => {
    ...
    return (
        <BeautifulWrapper
            ...
            description={
                <Description>
                    Columns can be moved to the first column by just drag and dropping, before drop, you can confirm or
                    cancel the action by using <PropName>onColMoved</PropName> callback.
                </Description>
            }>
            <DataEditor
                {...defaultProps}
            ...
            description={
                <>
                    <Description>
                        ...
                        <PropName>bgSelectedColumnIcon</PropName>, <PropName>bgSelectedColumnHeader</PropName> theme
                        variables.
                    </Description>
                </>
            }>
