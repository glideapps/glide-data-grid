...
const DataGrid = (p, forwardedRef) => {
    ...
    const isOverHeaderElement = React.useCallback((canvas, col, clientX, clientY) => {
        ...
        if (!isDragging && !isResizing && !(hoveredOnEdge ?? false)) {
            ...
            const headerLayout = (0, data_grid_render_header_js_1.computeHeaderLayout)(undefined, header, headerBounds.x, headerBounds.y, headerBounds.width, headerBounds.height, theme, (0, utils_js_1.direction)(header.title) === "rtl");
            if (header.hasMenu === true &&
                headerLayout.menuBounds !== undefined &&
                (0, math_js_1.pointInRect)(headerLayout.menuBounds, clientX, clientY)) {
                return {
                    area: "menu",
                ...
                (0, math_js_1.pointInRect)(headerLayout.indicatorIconBounds, clientX, clientY)) {
                return {
                    area: "indicator",
    ...
    (0, utils_js_1.useEventListener)("touchstart", onMouseDownImpl, windowEventTarget, false);
    (0, utils_js_1.useEventListener)("mousedown", onMouseDownImpl, windowEventTarget, false);
    ...
    (0, utils_js_1.useEventListener)("mouseup", onMouseUpImpl, windowEventTarget, false);
    (0, utils_js_1.useEventListener)("touchend", onMouseUpImpl, windowEventTarget, false);
    ...
    (0, utils_js_1.useEventListener)("click", onClickImpl, windowEventTarget, false);
    ...
    (0, utils_js_1.useEventListener)("mousemove", onMouseMoveImpl, windowEventTarget, true);
                ...
                if (row !== undefined) {
                    ...
                    if (ctx !== null) {
                        ...
                        if (row === -1) {
                            ...
                            (0, data_grid_render_header_js_1.drawHeader)(ctx, 0, 0, boundsForDragTarget.width, boundsForDragTarget.height, mappedColumns[col], false, theme, false, undefined, undefined, false, 0, spriteManager, drawHeaderCallback, false);
                        }
                        else {
